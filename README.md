...
1. Um **usuário** pode alugar um livro.  
2. Um **livro** só pode estar alugado para **um usuário por vez**.  
3. Um usuário pode ter mais de um livro alugado.  
4. Um livro que já estiver alugado **não pode ser alugado novamente**.  
5. Quando um usuário devolver um livro, o livro deverá ficar disponível novamente para outro usuário.  
6. O sistema deve informar quando um livro não estiver disponível para aluguel.
